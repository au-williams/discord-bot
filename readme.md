...
These are the JavaScript files in the `plugins` folder. Files of the same name in JSON format are their config files. These plugins may have their own config files to update before they can run ...
